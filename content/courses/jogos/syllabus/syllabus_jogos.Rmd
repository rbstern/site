...
- Aulas: 2as 16h00-17h40, 4as: 14:00-15h40

- Instruções para o envio de e-mails: 
Por favor adicione ``[Jogos]'' ao 
...
- Traduzir situações em que vários agentes tomam decisões simultaneamente em modelos de jogos
- Prever o comportamento de agentes racionais agindo simultaneamente
...
```{r echo = FALSE, message = FALSE}
library(magrittr)
keys = c("Participação (geral)", "Prova 1", "Prova 2", "Seminário")
...
```{r echo = FALSE, message = FALSE}
`%>%` = magrittr::`%>%`
calendar_table = readr::read_csv("calendar_jogos.csv") %>% 
